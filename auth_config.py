...
class AuthSettings(BaseSettings):
    ...
    FRONTEND_URL: str = os.getenv("FRONTEND_URL", "https://routinez.app")
    BACKEND_URL: str = os.getenv("BACKEND_URL", "https://connect.routinez.app")
    SECRET_PASSWORD: str = os.getenv("SECRET_KEY", "default-not-used")
